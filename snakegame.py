...
pygame.init()
pygame.display.set_caption("SNAKE GAME BY DEVRAM")
pygame.font.init()
random.seed()
...
# I will declare global constant definitions

SPEED = 0.36
SNAKE_SIZE = 9
APPLE_SIZE = SNAKE_SIZE     #  both food and size of snake same
SEPARATION = 10    # separation between two pixels
SCREEN_HEIGHT = 600
SCREEN_WIDTH = 800
FPS = 25       #frame per second display
...
# I  will make class for food of the snake let's name it as apple
...
class Apple:
    def __init__(self, x ,y,state):
        ...
        self.y = y
        self.state = state
        self.color = pygame.color.Color("pink")     # color of food
...
# I will define moves of the snake
    ...
    # I will make the function of crashing when snake eats itself
